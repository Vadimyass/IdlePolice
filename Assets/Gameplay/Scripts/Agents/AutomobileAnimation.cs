...
{
    public class AutomobileAnimation : AgentAnimation
    {
        ...
        public override void PlayMoveAnimation()
        {
            ...
            _moveSeq.Append(transform.DOScaleY(1.3f, 0.15f).SetUpdate(true));
            _moveSeq.Join(transform.DOScaleX(1.05f, 0.15f).SetUpdate(true));
            _moveSeq.Append(transform.DOScaleY(1, 0.15f).SetUpdate(true));
            _moveSeq.Join(transform.DOScaleX(1, 0.15f).SetUpdate(true));
